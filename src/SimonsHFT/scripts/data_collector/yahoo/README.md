...
> If the above ready-made data can't meet users' requirements,  users can follow this section to crawl the latest data and convert it to qlib-data.
  1. download data to csv: `python scripts/data_collector/yahoo/collector.py download_data`
     ...
     - examples:
          ...
          # cn 1min data
          python collector.py download_data --source_dir /root/onethingai-tmp/.qlib/stock_data/source/cn_data_1min --start 2024-06-10 --end 2024-06-14 --delay 1 --interval 1min --region CN
          ...
          # us 1min data
          python collector.py download_data --source_dir /root/onethingai-tmp/.qlib/stock_data/source/us_data_1min --start 2024-06-01 --end 2024-06-05 --delay 1 --interval 1min --region US
          ```
