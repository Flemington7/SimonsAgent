...
class NestedDecisionExecutionWorkflow:
    ...
    def _init_qlib(self):
        """initialize qlib"""
        provider_uri_day = "/root/onethingai-tmp/.qlib/qlib_data/cn_data" # target_dir
        GetData().qlib_data(target_dir=provider_uri_day, region=REG_CN, version="v2", exists_skip=True)
        provider_uri_1min = "/root/onethingai-tmp/.qlib/qlib_data/cn_data_1min"
        GetData().qlib_data(
    ...
    def backtest(self):
        ...
        # user could use following methods to analysis the model
